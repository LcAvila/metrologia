      ...
      <div className="flex-1 transition-all duration-300">
        ...
        <div className="bg-[var(--card-bg)] p-4 rounded-lg shadow mb-4 border border-[var(--card-border)]">
          <div className="mb-2 border-b border-[var(--card-border)] pb-2">
            <h2 className="text-lg font-semibold text-[var(--foreground)] inline-flex items-center">
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-2">
              ...
              <div className="col-span-2 md:col-span-1">
                <label htmlFor="certificateNumber" className="text-sm font-medium text-[var(--foreground)] mb-1 flex items-center">
              ...
              <div className="col-span-2 md:col-span-1">
                <DatePicker
                  ...
                  onChange={(date: DateString) => setFormData(prev => ({ ...prev, receiveDate: date }))}
                  label="Recebimento"
              ...
              <div className="col-span-2 md:col-span-1">
                <DatePicker
                  ...
                  onChange={(date: DateString) => setFormData(prev => ({ ...prev, issueDate: date }))}
                  label="Emissão"
                  placeholder="Selecione a data"
                  icon={<FaCalendarAlt />}
                />
              ...
              <div className="col-span-4 md:col-span-2">
                <label htmlFor="equipment" className="text-sm font-medium text-[var(--foreground)] mb-1 flex items-center">
              ...
              {/* Identificação */}
              <div className="col-span-2 md:col-span-1">
                <label htmlFor="identification" className="text-sm font-medium text-[var(--foreground)] mb-1 flex items-center">
              ...
              {/* Setor */}
              <div className="col-span-4 md:col-span-2">
                <label htmlFor="sector" className="text-sm font-medium text-[var(--foreground)] mb-1 flex items-center">
